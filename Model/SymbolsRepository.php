...
class SymbolsRepository implements \MageSuite\ProductSymbols\Api\SymbolsRepositoryInterface
{
    ...
    /**
     * @var ResourceModel\Symbols\CollectionFactory
     */
    ...
    /**
     * @var Symbols\Processor\SaveFactory
     */
    private $saveFactory;

    /**
     * @var Symbols\Processor\UploadFactory
     */
    private $uploadFactory;


    public function __construct(
        \MageSuite\ProductSymbols\Model\ResourceModel\Symbols $symbolResource,
        SymbolsFactory $symbolFactory,
        ...
        \MageSuite\ProductSymbols\Model\Symbols\Processor\UploadFactory $uploadFactory
    )
    {
