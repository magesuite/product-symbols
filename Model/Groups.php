...
class Groups extends \Magento\Catalog\Model\AbstractModel implements \MageSuite\ProductSymbols\Api\Data\GroupsInterface
{
    ...
    {
        $this->_init('MageSuite\ProductSymbols\Model\ResourceModel\Groups');
    }
